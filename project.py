...
def CategoryItems(category_id): 
	...
	return render_template('category.html', items =items, category_id=category_id) 

@app.route('/category/<int:category_id>/additem', methods = ['POST', 'GET'])
def addItem(category_id):
	if request.method == 'POST':
		newItem = Item(name = request.form['name'], image_url = request.form['image_url'], category_id = category_id)
		session.add(newItem)
	 	session.commit()
